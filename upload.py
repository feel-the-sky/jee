...
# === Add one chapter in physics ===
chapter_name = "Oscillations"
questions = 120
chapter_idx = 15   # set index based on order in subject

doc_ref = db.collection("physics").document(chapter_name.lower().replace(" ", "_"))
doc_ref.set(default_chapter(chapter_idx, chapter_name, questions))

print(f"Added {chapter_name} ({questions} questions) to physics")